...
export class ReviewController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The Review have been successfully created.',
  ...
  @ApiResponse({
    status: 404,
    description: 'Not Found. The Review was not found for the provided Id.',
  })
  @ApiResponse({
    status: 400,
  ...
  @ApiResponse({
    status: 404,
    description: 'No Review found for the given id.',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized. Invalid token.' })
  @Delete('/:id')
