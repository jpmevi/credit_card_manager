...
export class init1699762939079 implements MigrationInterface {
    name = 'init1699762939079'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`account\` (\`number\` varchar(50) NOT NULL, \`doe\` date NOT NULL, \`cvv\` varchar(255) NOT NULL, \`status\` enum ('enabled', 'disabled', 'deleted') NOT NULL DEFAULT 'enabled', \`balance\` decimal(10,2) NOT NULL, \`limit\` decimal(10,2) NOT NULL, \`rejections\` int UNSIGNED NOT NULL, \`username\` varchar(255) NOT NULL, \`id_account_type\` int NOT NULL, PRIMARY KEY (\`number\`)) ENGINE=InnoDB`);
